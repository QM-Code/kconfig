...
| `cmake.md` | `overseer` | `in progress (created; dual-agent dispatch pending)` | Publish `C0` symmetry contract and dispatch parallel `BZ3-S1`/`KARMA-S1` specialist packets. | `2026-02-21` |
