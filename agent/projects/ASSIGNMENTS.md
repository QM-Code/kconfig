...
| `hardcoded.md` | `overseer` | `in progress (new hardcoded literal migration track)` | Execute Part (3) fallback-control-flow removals, then run first Part (1) i18n migration slice. | `2026-02-23` |
