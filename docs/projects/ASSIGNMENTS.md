...
| `physics-refactor.md` | `specialist-physics-refactor` | `in progress (Phase 0/1 world/body/controller facade scaffolding landed over BodyId core)` | `KARMA intake`: execute Phase 2 component-model slice for collider/controller intent data and sync ownership boundaries. | `2026-02-18` |
