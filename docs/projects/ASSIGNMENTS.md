...
| `karma-shadow-intake-p0.md` | `overseer` | `priority/queued (P0 integration track created)` | `KARMA intake`: issue first specialist slice for point-shadow contract scaffolding plus moving-caster refresh policy. | `2026-02-16` |
