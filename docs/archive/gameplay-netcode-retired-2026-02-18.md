...
Retired from active `docs/projects/` on `2026-02-18`.
Consolidated into: `docs/projects/gameplay-migration.md` (Track D netcode parity lane).

## Project Snapshot
- Current owner: `overseer` (historical)
- Status: `retired/merged into gameplay-migration`
- Immediate next task: `none` (continue under `docs/projects/gameplay-migration.md`).
