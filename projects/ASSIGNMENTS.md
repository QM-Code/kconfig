...
Update rules:
- One row per active project file in `config/projects/` (exclude `AGENTS.md` and `ASSIGNMENTS.md`).
...
| `headers.md` | `overseer` | `not started` | Run H0 baseline: remove one BZ3 target's local `include/karma` shadowing and validate SDK-only include resolution. | `2026-02-19` |
